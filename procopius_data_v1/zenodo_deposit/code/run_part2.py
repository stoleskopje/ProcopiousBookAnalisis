...
Output:
    /home/claude/part2_results.json          — all counts, per-book, English+Greek
    /home/claude/validation_sample_part2.csv — 100 random matches for manual check
...
OUT_JSON = '/home/claude/part2_results.json'
OUT_CSV  = '/home/claude/validation_sample_part2.csv'
PART_NUMBER = 2
...
for i in range(11, EXPECTED_FILES + 11):
    found = None
